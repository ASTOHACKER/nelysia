...
Measured locally with 10 repeats, 1 second per repeat, 10 concurrent workers, and zero failures. This is the historical baseline; historical v0.5.1 release evidence is documented separately in the dedicated 30-second × 7 reports.
