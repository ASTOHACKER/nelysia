...
- Current package line: **`1.2.2`**
- Current public GitHub release/tag: **`v1.2.2`** ([release page](https://github.com/ASTOHACKER/nelysia/releases/tag/v1.2.2))
- The v1.0 API contract remains frozen. v1.1.0, v1.2.0, v1.2.1, and v1.2.2 are additive; bug fixes and security fixes may ship in `1.2.x`; breaking changes belong in `2.0`.
...
- The Bun stabilization gate is `no-performance-claim`. The 24-hour soak is deferred, and production readiness is not declared solely because the package reached `1.2.2`.
...
| GitHub tag/release | What public source/artifact was released? | Use the immutable `v1.2.2` tag and release. |
...
`v0.5.1`, `v0.6.0`, `v1.0.0`, `v1.1.0`, `v1.2.0`, and `v1.2.1` are immutable historical releases. They remain in
...
- package ปัจจุบัน: **`1.2.2`**
- GitHub release/tag สาธารณะปัจจุบัน: **`v1.2.2`** ([หน้า release](https://github.com/ASTOHACKER/nelysia/releases/tag/v1.2.2))
- API contract ของ v1.0 freeze แล้ว; v1.1.0, v1.2.0, v1.2.1 และ v1.2.2 เพิ่มความสามารถแบบ additive, `1.2.x` แก้ bug/security และ breaking change ไป `2.0`
- npm publish เป็นงานแยกต่างหาก การมี GitHub release ไม่ได้แปลว่า `npm install @narudom96/nelysia` ใช้จาก npm ได้แล้ว
- Bun stabilization gate เป็น no-performance-claim, soak 24 ชั่วโมงถูกเลื่อนไว้ และยังไม่ประกาศ production readiness จากการออก v1.2.2 เพียงอย่างเดียว
...
| GitHub tag/release | source/artifact สาธารณะคืออะไร | ใช้ tag/release `v1.2.2` ที่แก้ย้อนหลังไม่ได้ |
...
`v0.5.1`, `v0.6.0`, `v1.0.0`, `v1.1.0`, `v1.2.0` และ `v1.2.1` เป็น release ในอดีตที่ immutable จึงยังอยู่ใน changelog,
