...
- Current package line: **`1.0.0`**
- Current public GitHub release/tag: **`v1.0.0`** ([release page](https://github.com/ASTOHACKER/nelysia/releases/tag/v1.0.0))
- The v1.0 API contract is frozen. Bug fixes and security fixes may ship in `1.0.x`; additive work may ship in `1.x`; breaking changes belong in `2.0`.
...
- The 24-hour soak is deferred. Production readiness is not declared solely because the package reached `1.0.0`.
...
| GitHub tag/release | What public source/artifact was released? | Use the immutable `v1.0.0` tag and release. |
...
- GitHub release/tag สาธารณะปัจจุบัน: **`v1.0.0`** ([หน้า release](https://github.com/ASTOHACKER/nelysia/releases/tag/v1.0.0))
- API contract ของ v1.0 freeze แล้ว: `1.0.x` แก้ bug/security, `1.x` เพิ่มความสามารถแบบ additive และ breaking change ไป `2.0`
- npm publish เป็นงานแยกต่างหาก การมี GitHub release ไม่ได้แปลว่า `npm install @narudom96/nelysia` ใช้จาก npm ได้แล้ว
- soak 24 ชั่วโมงถูกเลื่อนไว้ และยังไม่ประกาศ production readiness จากการออก v1.0.0 เพียงอย่างเดียว
...
| GitHub tag/release | source/artifact สาธารณะคืออะไร | ใช้ tag/release `v1.0.0` ที่แก้ย้อนหลังไม่ได้ |
